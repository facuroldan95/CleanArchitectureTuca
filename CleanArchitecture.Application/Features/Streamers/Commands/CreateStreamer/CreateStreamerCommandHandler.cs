...
{
    public class CreateStreamerCommandHandler : IRequestHandler<CreateStreamerCommand, string>
    {
        ...
        public async Task<string> Handle(CreateStreamerCommand request, CancellationToken cancellationToken)
        {
            ...
            return newStreamer.Id.ToString();
        }
